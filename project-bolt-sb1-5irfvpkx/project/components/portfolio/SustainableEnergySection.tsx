...
export default function SustainableEnergySection() {
  ...
  return (
    <section className="relative w-full min-h-[85vh] flex items-center justify-center px-6 py-16 overflow-hidden">
      
      {/* Soft Burgundy & Wine Ambient Glows */}
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-[#6B2D34]/20 rounded-full blur-[150px] pointer-events-none"></div>

      <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-12 items-center relative z-20">
        
        {/* Left Column: Title & Content */}
        <div className="space-y-6">
          <div className="inline-block px-4 py-1.5 rounded-full bg-[#5A1A22]/50 text-[#803941] text-xs font-bold tracking-widest uppercase border border-[#803941]/50 shadow-[0_0_20px_rgba(128,57,65,0.3)]">
        ...
        {/* Right Column: Perfectly Centered Interactive Badge */}
        <div className="flex justify-center items-center py-6">
          <motion.div
            ...
            className="cursor-grab z-30 flex flex-col items-center touch-none select-none"
          >
            {/* Lanyard Top Strap */}
